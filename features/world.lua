...
task.spawn(function()
    ...
    UI.Header(cW,0,130,COLW*2+8,"WORLD FX")
    UI.Row(cW,LX,152,COLW,"Full Bright",function() return Hub.Get("FULLBRIGHT",false) end,function(v) Hub.Set("FULLBRIGHT",v) applyWorld() end)
    UI.Row(cW,RX,152,COLW,"World Color",function() return true end,function() end,function() return Hub.Get("WORLD_C",Color3.fromRGB(255,255,255)) end,function(c) Hub.Set("WORLD_C",c) applyWorld() end)
    UI.Step(cW,0,186,COLW*2+8,"Time",function() return Hub.Get("TIME",14) end,function(v) Hub.Set("TIME",v) applyWorld() end,1,0,24)
